...
internal sealed class MistralModelChatClientBridge : IChatClient
{
    private readonly MistralModelClient _client;

    public MistralModelChatClientBridge(MistralModelClient client) => _client = client;
